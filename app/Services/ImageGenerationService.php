...
class ImageGenerationService
{
    ...
    public static function generateImageFromModel(
        ...
        try {
            ...
            $colorPalette = match (true) {
                ...
                default => self::getColormapFromImageFormat($imageSettings['image_format'] ?? ImageFormat::AUTO->value),
            };
    ...
    private static function getMimeTypeFromImageFormat(string $imageFormat): string
    {
        return match ($imageFormat) {
            ...
            ImageFormat::PNG_8BIT_BWR_3C->value => 'image/png',
    ...
    private static function getColorsFromImageFormat(string $imageFormat): int
    {
        return match ($imageFormat) {
            ...
            ImageFormat::PNG_8BIT_BWR_3C->value => 3,
    ...
    private static function getBitDepthFromImageFormat(string $imageFormat): int
    {
        return match ($imageFormat) {
            ...
            ImageFormat::PNG_8BIT_BWR_3C->value => 8,
    ...
    /**
     * Get hardcoded colormap for ImageFormats that imply a fixed palette
     * (e.g. BWR = Black/White/Red). Returns null for formats without an
     * implied palette.
     *
     * @return array<int, string>|null
     */
    private static function getColormapFromImageFormat(string $imageFormat): ?array
    {
        return match ($imageFormat) {
            ImageFormat::PNG_8BIT_BWR_3C->value => ['#000000', '#FFFFFF', '#FF0000'],
            default => null,
        };
    }
